...
class Constant : public Expression {
  public:
    ...
    virtual Rectangle*  as_rectangle() const=0;
    virtual Circle*     as_circle()    const=0; 
    virtual Textbox*    as_textbox()   const=0; 
    virtual Triangle*   as_triangle()  const=0; 
    virtual Pixmap*     as_pixmap()    const=0; 
    virtual Animation_block* as_animation_block() const=0;
